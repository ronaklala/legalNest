        ...
        <div className="row">
          ...
          >
            <main id="main" className="site-main" role="main">
              <div
                id="post-140"
                className="post-140 page type-page status-publish hentry"
              >
                  ...
                  <div className="wpb-content-wrapper">
                      ...
                      <div className="wpb_column vc_column_container vc_col-sm-12">
                        <div className="vc_column-inner">
                          <div className="wpb_wrapper">
                            <div
                              className="st-custom-heading-wraper st-custom-heading-layout1 text-center"
                            ...
                            >
                              <h2
                                ...
                                style={{ color: "" }}
                              >
                                <span className="heading-text"> Our Team</span>
                              </h2>
                              <hr
                    ...
                    <div className="vc_row wpb_row vc_row-fluid vc_custom_1448546764167">
                      <div className="wpb_column vc_column_container vc_col-sm-12">
                        <div className="vc_column-inner">
                          <div className="wpb_wrapper">
                            <div className="vc_separator wpb_content_element vc_separator_align_center vc_sep_width_100 vc_sep_pos_align_center vc_separator_no_text vc_custom_1448535029352 wpb_content_element vc_custom_1448535029352 wpb_content_element">
                              <span className="vc_sep_holder vc_sep_holder_l">
                                <span
                                  style={{ borderColor: "#dee6eb" }}
