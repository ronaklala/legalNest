                                ...
                                <rs-slides>
                                  ...
                                  >
                                    ...
                                    <rs-layer
                                      ...
                                      style={{
                                        zIndex: 7,
                                        backgroundColor: "rgba(254,87,34,1)",
                                        fontFamily: '"Karla"',
                                        outline: "none",
                                        boxShadow: "none",
                                  ...
                                  <rs-slide
                                    ...
                                    data-key="rs-6"
                                    data-title="Slide"
                                    data-thumb="//demo.themeamber.com/consultancy/wp-content/uploads/2016/01/slider2-50x50.jpg"
                                    data-anim="ms:600;"
                                    data-in="o:0;"
                                    data-out="a:false;"
                                  >
                                    <img
                                      ...
                                      title="Home"
                                      className="rev-slidebg tp-rs-img rs-lazyload"
                                      data-lazyload="//demo.themeamber.com/consultancy/wp-content/uploads/2016/01/slider2.jpg"
                                      data-no-retina=""
                                    />{" "}
                                    {/*
                                     */}
                    ...
                    <div className="wpb_column vc_column_container vc_col-sm-4">
                      <div className="vc_column-inner vc_custom_1451624060187">
                        <div className="wpb_wrapper">
                          ...
                          <a
                            href="#"
                            className="btn  btn-regular btn-ocustom text-default"
                            style={{
                              marginTop: 45,
                              borderColor: "#26bbff",
                              color: "#ffffff"
                      ...
                      <div className="vc_column-inner vc_custom_1451624045846">
                        <div className="wpb_wrapper">
                          ...
                          >
                            ...
                            >
                              {" "}
                              <span className="heading-text"> Services</span>
                            </h2>
                            <hr
                              className="heading-line"
                                    ...
                                    <div className="st-feature-box">
                                      <div className="st-feature-box-icon">
                                        <div className="feature-box-image">
                                          ...
                                          <img
                                            decoding="async"
                                            src="wp-content/uploads/2015/11/icon3.png"
                                            alt=""
                                          />
                                        </div>
                                      </div>
                              ...
                              <div className="st-carousel-item primary-background-hover">
                                <div className="st-carousel-media  has-thumbnail">
                                  ...
                                  <noscript>
                                    ...
                                    size-consultancy-project-thumb wp-post-image
                                    lazyload" alt="" /&gt;
                                  </noscript>
                                </div>
